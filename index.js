...
function copylift(e) {
  ...
  console.log(containerLift);
  console.log(typeof containerLift);
  console.log(typeof containerLift.innerHTML);
  console.log(containerLift.innerHTML);
...
function LiftStatus(ClickedFloor) {
  ...
  // liftt.forEach((e) => {
  //   if (!e.classList.contains("busy")) {
  //     console.log(e);
  //     MovingTheLift(ClickedFloor, e);
  //     return;
  //   }
  // });
  let i;
